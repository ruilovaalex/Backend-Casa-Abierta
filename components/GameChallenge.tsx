...
const ALL_SCENARIOS: GameScenario[] = [
  ...
  { id: 25, difficulty: 'normal', task: "Verificar la identidad del usuario mediante un Token JWT.", correct: 'backend', explanation: "La autenticación y validación de sesiones es el núcleo del Backend." },
